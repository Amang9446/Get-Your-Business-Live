...
export default function Intro({business}) {
    ...
    const onDelete = () => {
        Alert.alert('Do you really want to Delete?', 'This will delete the business', [
            {
                text: 'Cancel',
                style: 'cancel'
            },
    ...
    return (
        <View>
            ...
            <Image style={{width: "100%", height: 340}} source={{uri: business?.imgUrl}}/>
            <View style={{
                padding: 20,
                backgroundColor: '#fff',
                marginTop: -20,
                ...
                <Text
                    style={{fontFamily: 'DmSans', fontSize: 17}}
                >
                    {business.address}
                </Text>
            </View>
