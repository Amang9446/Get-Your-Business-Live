...
export default function BusinessList({business}) {
    ...
    return (
        <TouchableOpacity
            ...
            <Image style={{width: 120, height: 120, borderRadius: 10}} source={{uri: business?.imgUrl}}/>
            <View style={{gap: 5, flex: 1}}>
                <Text style={{fontFamily: 'DmSans', fontSize: 25}}>{business?.name}</Text>
                <Text style={{color: Colors.GRAY, fontSize: 17}}>{business?.address}</Text>
                <View>
                ...
                <View style={{display: "flex", flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    >
                        <Text
                            style={{color: Colors.PRIMARY, fontSize: 15}}> {business?.contact}
                        </Text>
                    </TouchableOpacity>
                </View>
            </View>
